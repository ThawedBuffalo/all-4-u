...
// import 'package:all_4_u/data/datasources/daos/category_dao.dart';
...
// import '../../mock/data/datasource/database/all4u_db.mocks.dart';
//
// //
// void main() {
//   final mockDatabase = MockTestAll4UDb();
...
//   //
//   // setUp(() async {
//   //   testDB = await $FloorFlutterDatabase.inMemoryDatabaseBuilder().build();
//   //   categoryDAO = testDB.categoryDAO;
//   // });
//
//   //when(mockDatabase.categoryDAO).thenReturn(mockDatabase.mockCategoryDAO);
//
//   final CategoryRepository repository =
//       CategoryRepository(database: mockDatabase);
//
//   // test data
//   final int testId = 7;
//   final String successTestName = 'successTestName';
//   final String failTestName = 'failedTestName';
//   final CategoryDTO successCategoryDTO =
//       CategoryDTO(id: null, name: successTestName);
//   final CategoryDTO failCategoryDTO = CategoryDTO(id: null, name: failTestName);
//
//   group('#create category', () {
//     setUp(() {
//       when(mockDatabase.categoryDAO.insertCategory(successCategoryDTO))
//           .thenAnswer(
//         (_) async => 1,
//       );
//
//       when(mockDatabase.categoryDAO.insertCategory(failCategoryDTO)).thenAnswer(
//         (_) async => null,
//       );
//     });
//
...
//
//       final result = await repository.createCategory(successTestName);
//
//       // verify(mockDatabase.categoryDAO.insertCategory(successCategoryDTO))
//       //     .called(1);
//       expect(result, equals(Right(successTestCategoryEntity)));
//     });
//
//     // test('should return DB Failure', () async {
//     //   final result = await repository.createCategory(failTestName);
//     //
//     //   verify(mockDatabase.categoryDAO.insertCategory(failCategoryDTO))
//     //       .called(1);
